...
class AppVertices: public Application
{
	...
	GLint uniColor, uniTime;
	std::chrono::time_point<std::chrono::high_resolution_clock> t_start, t_now;
	float time;
	...
	virtual void startup() override
	{
		...
		std::string vShaderStr = load_shader("tx2.vert");
		...
		std::string fShaderStr = load_shader("tx3.frag");
